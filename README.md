...
all data are stored in memory, not h2 or other related db. the application will initialize some data, like users, roles(_admin_, _sales_, _guest_), to easy you run this demo.
## install
1. clone it
